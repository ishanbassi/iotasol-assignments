                ...
                <tbody>
                    {
                        data.map((detail,i) => {
                            return (
                                <tr>
                        <td>
                            <input type="text" name="small" id="small"  value={detail.textbox} onChange={e => updateData(e,i)} />
                        </td>
                        <td>
                        ...
                        <td>
                            <div>
                                ...
                                <input type="radio" name={`rd_${i}`} id={`rd1_${i}`} value="rd1" onChange={e => updateData(e,i)} checked={detail.radio1}/>
                            </div>
                            <div>
                                <label htmlFor={`rd2_${i}`}>rd2</label>
                                <input type="radio" name={`rd_${i}`} id={`rd2_${i}`} value="rd2" onChange={e => updateData(e,i)}checked={detail.radio2}/>
                            </div>
                            <div>
                                <label htmlFor={`rd3_${i}`}>rd3</label>
                                <input type="radio" name={`rd_${i}`} id={`rd3_${i}`} value="rd3" onChange={e => updateData(e,i)} checked={detail.radio3}/>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <select name="select" id="select" onChange={e => updateData(e,i)}>
