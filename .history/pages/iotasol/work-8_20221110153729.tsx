    ...
    return (
        <>
                ...
                <tbody>
                    {
                        data.map(detail => {
                            return (
                                <tr>
                        <td>
                            <input type="text" name="small" id="small"  value={detail.textbox}/>
                        </td>
                        <td>
                            <textarea name="details" id="details" cols={15} rows={1} value={detail.textarea}></textarea>
                        </td>
                        <td>
                            <div>
            ...
            <div className="action-btns">
                ...
                <Button variant="primary" size="sm"  type="button" name="insert">Insert</Button>
