    ...
    return (
        <Container>
            <Row className="mt-5">
                ...
                <Col md="3">
                        <Button size="sm" onClick={moveRight} className="btn-10" disabled={select1Values.length > 0}>moveRight &gt;&gt;</Button>
                        <Button size="sm" onClick={moveLeft} className="btn-10" disabled={select2Values.length > 0}>&lt;&lt; moveLeft</Button>
