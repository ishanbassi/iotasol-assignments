    ...
    return (
        <>
            ...
            <div className="action-btns">
                ...
                <Button  variant="primary" size="sm" type="button" name="populate" onClick={populateData}>populate</Button>
                <Button  variant="primary" size="sm" type="button" name="delete" onClick={deleteData}>Delete</Button>
                <Button  variant="primary" size="sm" type="button" name="delete" onClick={refreshRow}>Refresh</Button>
            </div>
