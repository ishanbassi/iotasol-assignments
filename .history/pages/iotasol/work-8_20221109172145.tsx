...
export default function App() {
    ...
    return (
        <>
            ...
            <div>
                <Button  variant="primary-outline" type="button" name="save">Save</Button>
                <Button variant="primary-outline"  type="button" name="insert">Insert</Button>
                <Button  variant="primary-outline" type="button" name="populate">populate</Button>
                <Button  variant="primary-outline" type="button" name="delete">Delete</Button>
            </div>
            <style jsx>{`
                    label{
                        padding-right:.5em;
